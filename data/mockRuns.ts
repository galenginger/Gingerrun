...
// Testdata så listan inte är tom vid allra första appstart, innan någon
// egen runda finns sparad på disk.
...
// Läser sparade rundor från disk (om filen finns) och fyller mockRuns
...
function saveRuns() {
  ...
  runsFile.write(JSON.stringify(mockRuns));
}
